...
`blok/laravel-modules` is a Laravel package which created to manage your large Laravel app using modules. Module is like a Laravel package, it has some views, controllers or models. This package is supported and tested in Laravel 5.
...
You'll find installation instructions and full documentation on [https://blok.com/laravel-modules/](https://blok.com/laravel-modules/).

## Credits

- [Nicolas Widart](https://github.com/blok)
